...
SRC_FILES := $(SRC_DIR)/main.c $(SRC_DIR)/src/sim_view.c $(SRC_DIR)/src/os_controller.c $(SRC_DIR)/src/scheduler_model.c $(SRC_DIR)/src/queue.c $(SRC_DIR)/src/process_queue.c
